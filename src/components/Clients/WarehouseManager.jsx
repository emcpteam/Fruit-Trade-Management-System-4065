...
const WarehouseManager = ({ client, onClose, onUpdate }) => {
  const [warehouses, setWarehouses] = useState(client.warehouses || []);
    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-xl font-semibold text-nordic-800">Gestione Magazzini</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    type="email"
                    className="w-full px-3 py-2 border border-nordic-200 rounded-lg focus:ring-2 focus:ring-sage-500 focus:border-transparent"
                    placeholder="magazzino@esempio.com"
                  />
                  {errors.email && (
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div>
                        <span className="font-medium text-nordic-700">Indirizzo:</span>
                      ...
                      <div>
                        {warehouse.contactPerson && (
                          <div className="mb-1">
                            <span className="font-medium text-nordic-700">Contatto:</span>
